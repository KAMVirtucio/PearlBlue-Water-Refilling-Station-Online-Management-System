...
<head>
    ...
    <link href="/PearlBlueWRS/css/cashier/paidordersdesign.css" rel="stylesheet" media="screen">	
...
<body>
    ...
    <div id="dashboardTextCont">
        <span id="dashboardTextTop">LIST OF PAID ORDERS</span>
        <hr>
    </div>
    ...
    <div id="inventoryCont">
        <div id="inventory">
            ...
            <?php
                ...
                $query = mysqli_query($con, "SELECT * FROM customerorders WHERE orderstatus = 'DELIVERED'");
