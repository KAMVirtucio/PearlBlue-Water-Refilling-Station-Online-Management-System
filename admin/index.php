...
<head>
    ...
    <link href="/PearlBlueWRS/css/admin/index.css" rel="stylesheet" media="screen">
</head>
<body>
    ...
    <div id="countStatContainer">
        ...
        <div id="countStatThree">
            <div id="boxCountStatThree">
                <div id="countThreeDesc">Containers Deficiency:</div>
                <div id="statresultThree">
                    <?php
                        echo "0";
                    ?>
                </div>
