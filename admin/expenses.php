...
<head>
    ...
    <link href="/PearlBlueWRS/css/admin/expenses.css" rel="stylesheet" media="screen">
</head>
<body>
    ...
    <div id="dashboardTextCont">
        <span id="dashboardTextTop">EXPENSES</span>
    </div>
    <div id="salesprogressContainer">
        <div id="salesprogress">
            <img src="/PearlBlueWRS/images/expenses.png" id="salesprogressPic">
        </div>
    </div>
</body>
</html>
