...
<body>
    ...
    <div id="searchfilterContainer">
        <div id="searchfilter">
            <div id="searchContainer" class="inlinesearchfilter">
                <form action="inventory-delivered-search.php" method="POST" class="inlinesearchfilter">
    ...
    <?php
        $query = mysqli_query($con, "SELECT * FROM customerorders WHERE orderstatus='DELIVERED' AND ordercustomername LIKE '%".$search."%' || orderstatus='DELIVERED' AND orderaddress LIKE '%".$search."%' || orderstatus='DELIVERED' AND ordercontactdetails LIKE '%".$search."%' || orderstatus='DELIVERED' AND orderdateordered LIKE '%".$search."%' || orderstatus='DELIVERED' AND ordernumber LIKE '%".$search."%' || orderstatus='DELIVERED' AND ordertype LIKE '%".$search."%' ORDER BY ordercustomerid DESC");
